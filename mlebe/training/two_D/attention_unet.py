...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, UpSampling2D, BatchNormalization, Input, \
    add, multiply
from tensorflow.keras.layers import Lambda, Dropout, concatenate, Activation
from tensorflow.keras.models import Model
# from tensorflow.keras.layers.merge import concatenate
from tensorflow.keras.optimizers import Adam

import mlebe.training.two_D.unet as u
...
def att_unet(img_w, img_h, n_label, data_format='channels_last'):
    ...
    model.compile(optimizer=Adam(lr=1e-5), loss=u.dice_coef_loss, metrics=['accuracy', u.dice_coef])
    return model
