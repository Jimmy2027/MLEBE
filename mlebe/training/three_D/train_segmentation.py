...
from mlebe.training.three_D.utils.error_logger import ErrorLogger
from mlebe.training.three_D.utils.finalize import finalize
from mlebe.training.three_D.utils.utils import json_file_to_pyobj, bigprint
from mlebe.training.three_D.utils.visualiser import Visualiser
...
def train(json_filename, network_debug=False, params=None, experiment_config=None):
    ...
    # get validation metrics
    val_loss_log = pd.read_excel(os.path.join(json_opts.model.checkpoints_dir, json_opts.model.experiment_name, 'loss_log.xlsx'),
                                 sheet_name='validation').iloc[:, 1:]
